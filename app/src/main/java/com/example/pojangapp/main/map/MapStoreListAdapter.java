...
public class MapStoreListAdapter extends RecyclerView.Adapter<MapStoreListAdapter.CustomViewHolder> {
    ...
    public MapStoreListAdapter(Context context, ArrayList<? extends HashMap<String, ?>> data, int resource, String[] from, int[] to){
    ...
    @NonNull
    @Override
    public MapStoreListAdapter.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.map_store_list_item, parent,false);
    ...
    @Override
    public void onBindViewHolder(@NonNull final MapStoreListAdapter.CustomViewHolder holder, int position) {
